    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-black'>It&apos;s our fourth Summer Course....... so exciting. Faculty of Law Universitas Trisakti colaborating with Faculty of Industrial technology Universitas Trisakti and Faculty of Law Universitas Warmadewa are excited to present summer course since it is a fun way to study in holiday time. Get experience in a new country, culture, learn the legal system and basics of a new language and web design, and of course gain friends from all over the world.</p>
