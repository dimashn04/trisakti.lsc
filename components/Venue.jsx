    ...
    <div id='venue' className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                <p className='uppercase text-xl tracking-widest text-[#8C323E] font-bold'>Venue</p>
                <p className='py-4 text-2xl font-bold text-[#574821]'>Visit Us</p>
                <p className='py-2 text-gray-700'>Faculty Of Law, Universitas Trisakti<br/>A Campus, H Building<br/>Jl. Kyai Tapa 1, Grogol, West Jakarta<br/>Indonesia</p>
