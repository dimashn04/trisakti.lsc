...
import kecak from '../public/assets/kecak.jpg'
import early_bid from '../public/assets/Early_bid.png'
    ...
    <div id='requirements' className='w-full md:h-screen p-2 flex items-center py-16 pt-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
                ...
                <div className=''>
                    <ol className='relative dark:border-gray-700'>
                        ...
                        <li className='mb-4 ml-4'>
                            ...
                            <a href="https://docs.google.com/document/d/19OHKSFYQzvXDZEYRU8BHyyU6uZb7mLCO/edit?usp=sharing&ouid=108108652241290983844&rtpof=true&sd=true" class="inline-flex items-center px-4 py-2 text-sm font-medium text-black bg-gradient-to-r from-[#F7F214] to-[#FFFA15] rounded-lg">Download the official statement letter template <svg class="w-3 h-3 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></a>
                        </li>
                        <li className='mb-4 ml-4'>
                            <div class="absolute w-3 h-3 bg-gray-600 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                            <p class="font-semibold text-gray-900 ">6. Must register</p>
                            <a href="https://forms.gle/dRn1wR1MrrKAjSadA" class="inline-flex items-center px-4 py-2 text-sm font-medium text-black bg-gradient-to-r from-[#F7F214] to-[#FFFA15] rounded-lg">Register now <svg class="w-3 h-3 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></a>
                        </li>
                        <li className='mb-4 ml-4'>
                            <div class="absolute w-3 h-3 bg-gray-600 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                    ...
                    <ol className='relative dark:border-gray-700'>
                        ...
                        <li className='mb-4 ml-4'>
                            ...
                            <p className="font-semibold text-gray-900 ">Additional Fee Info:</p>
                            <Image src={kecak} alt="Deskripsi Gambar" className="mt-2 w-64 h-auto rounded-lg shadow-md" />
                        </li>
                    </ol>
                    <p className='pb-8'>Transfer to <span className='text-yellow-200 text-xl font-bold hover:border-b border-[#8C323E]'><a href='https://docs.google.com/document/d/19OHKSFYQzvXDZEYRU8BHyyU6uZb7mLCO/edit?usp=sharing&ouid=108108652241290983844&rtpof=true&sd=true'>(see link in official statement letter)</a></span></p>
            ...
            <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300 bg-gradient-to-r from-[#F7F214] to-[#FFFA15]'>
                <Image className='rounded-xl' src={early_bid} alt="" />
            </div>
        </div>
    </div>
  )
